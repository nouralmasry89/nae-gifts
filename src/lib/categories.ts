...
export const categories: Category[] = [
  ...
  { slug: "ramadan", name: "رمضان و الأعياد", description: "تشكيلة كبيرة من هدايا وزينة وتوزيعات وصواني شهر رمضان المبارك والأعياد الإسلامية والمسيحية، كما يمكنكم طلب أي تصميم غير موجود ضمن القوائم، ويمكنكم أيضاً تخصيص أي قطعة من هدايا ناي لتكون بإسم أو صورة صاحب الهدية.", image: ramadan },
  ...
  { slug: "newborn", name: "مولود جديد", description: "هدايا مباركة وتوزيعات وزينة قدوم مولود جديد تجدونها ضمن تشكيلة لا تنتهي من التصاميم لدى هدايا ناي، والتي يمكنكم طبعاً تخصيصها بإسم ومعلومات الملاك الجديد للعائلة.", image: newborn },
];
